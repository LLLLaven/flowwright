...
import {
  FilePlus2, FolderOpen, Save, Plus, Search, X, Play, Pause, Square, Undo2, Redo2,
} from "lucide-react";
...
export default function TopBar({
  runState, onToggleRun, onStop, prompt, onPromptChange, onSave, onAddNode, running,
}: TopBarProps) {
  return (
    <div className="flex h-12 shrink-0 items-center gap-2 border-b border-[#1e293b] bg-[#111a2e] px-3">
      ...
      <Group>
        ...
        <IconBtn label="保存 (Ctrl+S)" onClick={onSave}><Save className="size-[17px]" /></IconBtn>
      </Group>
