...
export default function StatusBar({ state, nodeCount, edgeCount }: StatusBarProps) {
    ...
    <div className="flex h-7 shrink-0 items-center gap-4 border-t border-[#1e293b] bg-[#0b1120] px-3 text-[11px] text-slate-400">
      <div className="flex items-center gap-1.5">
        <span className="relative flex size-2">
          {state !== "ready" && (
            <span className="absolute inline-flex size-2 animate-ping rounded-full opacity-70"
